const Discord = require('discord.js');const cfg = require('./config');const bot = new Discord.Client();const client = new Discord.Client({disableEveryone: true});const createCaptcha = require('./captcha');const fs = require('fs').promises;const { createPool } = require('mysql');const mysql = require('mysql2/promise');const xpfile = require('./xp.json')
